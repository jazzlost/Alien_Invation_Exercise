...
def run_game():
    ...
    while True:
        # 键盘和鼠标事件
        gf.check_events(game_setting, screen, stats, board,
        ...
        if stats.game_active:
            ...
            # 子弹刷新
            gf.update_bullets(game_setting, screen, stats,
                              board, ship, aliens, bullets)

            # 外星人刷新
            gf.update_aliens(game_setting, stats, board,
                             screen, aliens, ship, bullets)

        # 屏幕刷新
        gf.update_screen(game_setting, screen, stats, board,
